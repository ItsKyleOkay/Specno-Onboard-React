  ...
  function RegisterNew() {
    firebase.auth().onAuthStateChanged(function (user) {
      db.collection("users").doc(user.uid).update({
        centre: "Rudolf Ginsberg, Kaffrarein Heights, King Williams Town",
                ...
                <div key={post.key}>
                  ...
                  (post.Grade >= 8) ? (
                    <span className={classes.Course}>
                      <h1>
                        The Inspire Academy in King Williams Town offers
...
export default RegisterCourseKwt;
